...
contains
  ...
  subroutine compute_forces(particles)
    ...
    particle_loop: do i = 1, size(particles)
  ...
  !+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
   ...
   pure subroutine compute_force_between_particles(particle_i, particle_j)
  ...
  function compute_locations(particles) result (displacement_flag)
     type(particle_type), dimension(:), intent(in out) :: particles
  ...
  subroutine compute_velocities(particles)
    type(particle_type), dimension(:), intent(in out) :: particles
